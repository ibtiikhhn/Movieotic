...
public class CreditTvAdapter extends RecyclerView.Adapter<CreditTvAdapter.CreditTvHolder> {
    ...
    Context context;
    List<com.codies.movieotic.Models.PersonModels.CreditTv.Cast> tvList;

    CreditTvClickListener clickListener;

    public CreditTvAdapter(Context context, List<com.codies.movieotic.Models.PersonModels.CreditTv.Cast> tvList, CreditTvClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull CreditTvHolder holder, int position) {
        com.codies.movieotic.Models.PersonModels.CreditTv.Cast cast = tvList.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (clickListener != null) {
                        com.codies.movieotic.Models.PersonModels.CreditTv.Cast cast = tvList.get(getAdapterPosition());

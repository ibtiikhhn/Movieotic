...
import com.codies.movieotic.Adapters.CreditMoviesAdapter;
import com.codies.movieotic.Adapters.CreditTvAdapter;
import com.codies.movieotic.ClickListeners.CreditMovieClickListener;
import com.codies.movieotic.ClickListeners.CreditTvClickListener;
import com.codies.movieotic.Models.PersonModels.CreditMovies.Cast;
...
import com.codies.movieotic.Models.PersonModels.People.Profile;
import com.codies.movieotic.R;
import com.codies.movieotic.ViewModels.PersonViewModel;
...
public class ProfileActivity extends AppCompatActivity implements CreditMovieClickListener, CreditTvClickListener {
    ...
    CardView moviesCV;
    CardView tvCV;
    List<com.codies.movieotic.Models.PersonModels.CreditTv.Cast> tvShows;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        personViewModel.getPersonMovies(personId).observe(this, new Observer<com.codies.movieotic.Models.PersonModels.CreditMovies.Example>() {
            @Override
            public void onChanged(com.codies.movieotic.Models.PersonModels.CreditMovies.Example example) {
        ...
        personViewModel.getPersonTv(personId).observe(this, new Observer<com.codies.movieotic.Models.PersonModels.CreditTv.Example>() {
            @Override
            public void onChanged(com.codies.movieotic.Models.PersonModels.CreditTv.Example example) {

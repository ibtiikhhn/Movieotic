...
import com.codies.movieotic.Adapters.CastAdapter;
import com.codies.movieotic.Adapters.CrewAdapter;
import com.codies.movieotic.ClickListeners.CastClickListener;
import com.codies.movieotic.ClickListeners.CrewClickListener;
import com.codies.movieotic.Models.MovieDetailModel.CrewCast.Cast;
import com.codies.movieotic.Models.MovieDetailModel.CrewCast.Crew;
import com.codies.movieotic.Models.MovieDetailModel.CrewCast.Example;
import com.codies.movieotic.R;
import com.codies.movieotic.ViewModels.DetailMoviesViewModel;
...
public class MovieDetailsActivity extends AppCompatActivity implements CastClickListener, CrewClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailMoviesViewModel.getMovieDetail(movieId).observe(this, new Observer<com.codies.movieotic.Models.MovieDetailModel.MovieModel.Example>() {
            @Override
            public void onChanged(com.codies.movieotic.Models.MovieDetailModel.MovieModel.Example example) {
                Glide.with(getApplicationContext()).load("https://image.tmdb.org/t/p/w500/" + example.getPosterPath()).into(moviePosterIv);
                Log.i(TAG, "onChanged: "+example.getPosterPath());
                String genres = null;
        ...
        detailMoviesViewModel.getMovieTrailor(movieId).observe(this, new Observer<com.codies.movieotic.Models.MovieDetailModel.Trailor.Example>() {
            @Override
            public void onChanged(com.codies.movieotic.Models.MovieDetailModel.Trailor.Example example) {
                if (example != null) {
